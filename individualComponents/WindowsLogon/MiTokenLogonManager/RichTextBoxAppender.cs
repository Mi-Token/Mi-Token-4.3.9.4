 ...
 * based on a mailing list entry by Stephanie Giovannini (giovannini-s.d.v@swbell.net)
 * http://article.gmane.org/gmane.comp.log.log4net.user/3494/
 */
...
namespace MiTokenWindowsLogon
{
    ...
    public class RichTextBoxAppender : AppenderSkeleton
    {
        ...
        public RichTextBoxAppender(RichTextBox myRichTextBox) : base()
        {
            ...
            //containerForm = (Form)richTextBox.Parent.Parent.Parent;
        }
        #endregion
        ...
        public void AddMapping(Level level, Color textColor, float pointSize, bool isBold)
        {
            LevelTextStyle lts = new LevelTextStyle();
            lts.Level = level;
            lts.TextColor = textColor;
            lts.PointSize = pointSize;
            lts.Bold = isBold;

            levelMapping.Add(lts);
        }
