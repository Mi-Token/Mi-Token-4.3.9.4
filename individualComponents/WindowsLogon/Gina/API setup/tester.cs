    ...
    public partial class tester : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                HttpWebRequest http = (HttpWebRequest)WebRequest.Create((checkBox1.Checked ? "http://" : "https://") + IP + "/mi-token/api/authentication/v4/RawHttpWithSSL/AnonVerifyOTPEx?username=" + txtboxUsername.Text + "&otp=" + txtboxOneTimePass.Text + "&flags=0");
                http.Proxy = null;
                http.Timeout = 1500;
