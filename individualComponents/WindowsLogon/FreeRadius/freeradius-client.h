...
#else
// Jegan #define		DEBUG(args...)	;
#endif

// Jegan #include	<sys/types.h>
/*
...
#define AUTH_ID_LEN_WITH_NULL_TERMINATOR 	AUTH_ID_LEN + 1	
#define AUTH_STRING_LEN		253	 /* maximum of 253 */
#define AUTH_STRING_LEN_WITH_NULL_TERMINATOR 	AUTH_STRING_LEN + 1
#define	BUFFER_LEN		8192

#define NAME_LENGTH		32
#define NAME_LENGTH_WITH_NULL_TERMINATOR NAME_LENGTH + 1
#define OTP_LENGTH_WITH_NULL_TERMINATOR 65
#define	GETSTR_LENGTH		128	/* must be bigger than AUTH_PASS_LEN */

#define	MAX_SECRET_LENGTH	(3 * 16) /* MUST be multiple of 16 */
#define	MAX_SECRET_LENGTH_WITH_NULL_TERMINATOR MAX_SECRET_LENGTH + 1
#define MD5_BUFFER_SIZE 256

#define HOST_NAME_LENGTH_WITH_NULL_TERMINATOR 256
...
#define ERROR_INVALID_SOCKET	-6
#define ERROR_AUTH_SERVER_NOT_FOUND	-5
#define ERROR_DICTIONARY	-4
#define ERROR_REGISTRY	-3
#define BADRESP_RC	-2
#define ERROR_RC	-1
#define OK_RC		0
#define TIMEOUT_RC	1
...
#define ERROR_INTERNAL_CONVERSION_FAILED 3
...
int rc_add_dictionary (rc_handle *rh, const char* namestr, const char *valstr, const char  *typestr);
...
void rc_event_log(DWORD errorId, DWORD categoryId, DWORD messageId, LPWSTR message, ...);
...
int decode_message(char* buffer, int bufferlength, int error_code);
__END_DECLS
