...
int debugLog = 0;
HANDLE debugMutex = INVALID_HANDLE_VALUE;

//Generic File Writing function - These functions presume the debugging is allowed
#define DEBUG_PATH "C:\\Program Files\\Mi-Token\\Mi-Token Desktop Logon\\DebugDLL.log"

//"C:\\Program Files\\Mi-Token\\Mi-Token Desktop Logon\\DebugBLE.log"
				 //"C:\\Program Files\\Mi-Token\\Mi-Token Desktop Login\\Debug.log"

char* filepath = NULL;

#define DEBUG_PATHS (filepath == NULL ? DEBUG_PATH : filepath)
