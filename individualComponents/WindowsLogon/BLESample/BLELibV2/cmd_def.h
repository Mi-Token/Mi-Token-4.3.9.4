...
extern const struct ble_msg  apis[];
/*
Stuff for our projects
*/

struct _user_init_data
{
	uint8 authAddress[6];
	int8 minRSSI;
	void (*callbackFound) ();
	int authAddressV2Size;
	uint8* authAddressV2;
};

extern int IIR_Percent;

extern struct _user_init_data user_init_data;


extern int PollEnabled;
extern int CurrentPollID;

//extern void (*connectionCallback) (ConnectionData* myData, uint8 connectionHandle);

/*
extern void (*serviceFoundCallback) (uint8 serviceHandleLength, const uint8* serviceHandleData, uint16 start, uint16 end);
extern void (*serviceSearchFinishedCallback) ();

extern void (*serviceInformationFoundCallback) (uint16 characteristicsHandle, uint8 dataLen, const uint8* data);
extern void (*serviceInformationCompletedCallback) ();
extern void (*handleValueCallback) (uint8 type, uint8 dataLen, const uint8* data);
extern void (*writeAttributeValueCallback) ();
*/


/*
Stuff that was in the API/Sample code
*/
...
#define HANDLER_START IMiTokenBLE* sender, 
#else
#define HANDLER_START 
#endif
typedef void (*ble_cmd_handler)(HANDLER_START const void*);
...
enum ble_event_ids
{
	...
	ble_evt_attributes_user_read_BLE_CONN=1,
...
enum ble_msg_idx
{
	...
	ble_evt_attributes_user_read_BLE_CONNx =190,
	...
	ble_evt_sm_passkey_BLE_CONNx =207,
...
void ble_default(HANDLER_START const void*);
#ifdef __cplusplus
}
#endif
