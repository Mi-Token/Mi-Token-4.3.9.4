...
static const struct ble_msg  apis[]={
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_evt|0x0,0x6,ble_cls_attributes,ble_evt_attributes_user_read_BLE_CONN}, 0x2442,	(ble_cmd_handler)ble_evt_attributes_user_read_request},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_evt|0x0,0x1,ble_cls_sm,ble_evt_sm_passkey_BLE_CONN}, 0x2,	(ble_cmd_handler)ble_evt_sm_passkey_request},
...
static const struct ble_msg* ble_class_attributes_evt_handlers[]=
{
	...
	&apis[ble_evt_attributes_user_read_BLE_CONNx],
